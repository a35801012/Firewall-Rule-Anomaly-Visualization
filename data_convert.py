...
with open('jsdata1.csv', 'w+',  newline = '') as csvFile:
        csvWriter = csv.writer(csvFile)
        csvWriter.writerow(df['A'])
        csvWriter.writerow(df['B'])
        csvWriter.writerow(df['C'])
        csvWriter.writerow(df['D'])
        csvWriter.writerow(df['E'])
        csvWriter.writerow(df['F'])
        csvWriter.writerow(df['G'])
        csvWriter.writerow(df['H'])
        csvWriter.writerow(df['I'])
        csvWriter.writerow(df['J'])
        csvWriter.writerow(df['K'])
        csvWriter.writerow(df['L'])
        csvWriter.writerow(df['M'])
        csvWriter.writerow(df['N'])
        csvWriter.writerow(df['O'])
        csvWriter.writerow(df['P'])
        csvWriter.writerow(df['Q'])
        csvWriter.writerow(df['R'])
        csvWriter.writerow(df['S'])
