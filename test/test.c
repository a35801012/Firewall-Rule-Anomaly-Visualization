...
{
	printf("11\nR%d & R%d anomaly : Shadowed\n",x,y);
	
	char a[150];
	int s=sprintf(a,"R%d,R%d,lightskyblue,Shadowed,%s,%s,%s,%s,%s,%s\n",x,y,xs,xd,ys,yd,xp,yp);
	fputs(a,fweb);
...
void redundant(int x,int y,int *fweb,char *xs,char *xd,char *ys,char *yd,char *xp,char *yp)
{
	...
	char a[150];
	int s=sprintf(a,"R%d,R%d,greenyellow,Redundant,%s,%s,%s,%s,%s,%s\n",x,y,xs,xd,ys,yd,xp,yp);
	fputs(a,fweb);
...
void general(int x,int y,int *fweb,char *xs,char *xd,char *ys,char *yd,char *xp,char *yp)
{
	...
	printf("\n\n%s%s%s%s%s%s\n\n",xs,xd,ys,yd,xp,yp);
	char a[150];
	int s=sprintf(a,"R%d,R%d,orange,General,%s,%s,%s,%s,%s,%s\n",x,y,xs,xd,ys,yd,xp,yp);
	printf("%s",a);		
	fputs(a,fweb);
...
void correlated(int x,int y,int *fweb,char *xs,char *xd,char *ys,char *yd,char *xp,char *yp)
{
	...
	char a[150];
	int s=sprintf(a,"R%d,R%d,yellow,Correlated,%s,%s,%s,%s,%s,%s\n",x,y,xs,xd,ys,yd,xp,yp);	
	fputs(a,fweb);
